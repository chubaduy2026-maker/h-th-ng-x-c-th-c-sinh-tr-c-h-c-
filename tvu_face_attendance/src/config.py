...
SCAN_DURATION_SECONDS = int(os.getenv("SCAN_DURATION_SECONDS", "6"))
...
DETECTION_SCORE_MIN = float(os.getenv("DETECTION_SCORE_MIN", "0.55"))
MIN_FACE_SIZE = LIVENESS_MIN_FACE_SIZE
MIN_BRIGHTNESS = LIVENESS_MIN_BRIGHTNESS
MIN_LAPLACIAN_VAR = LIVENESS_MIN_LAPLACIAN_VAR
DEBOUNCE_SECONDS = float(os.getenv("DEBOUNCE_SECONDS", "5"))
RECOGNITION_CONFIRM_FRAMES = int(os.getenv("RECOGNITION_CONFIRM_FRAMES", "2"))
